...
config_path = '/home/tongtong/python_project/nlp_project/chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/home/tongtong/python_project/nlp_project/chinese_L-12_H-768_A-12/bert_model.ckpt'
vocab_path = '/home/tongtong/python_project/nlp_project/chinese_L-12_H-768_A-12/vocab.txt'
topk = 3
...
model.summary()
C = CharFuncs('/home/tongtong/python_project/nlp_project/chinese_spelling_correction/data/char_meta.txt')
    ...
    for candidate_probs, candidate_probs_index, char in zip(probs, topk_probs_index, tokens[1:-1]):
        ...
        if candidate[0] != char:
            ...
            for c, b in zip(candidate, candidate_prob_topk):
                sim = C.similarity(char, c, weights=(0.8, 0.2, 0.0))  #TODO: weight?
                score = 0.6 * b + 0.4 * sim
